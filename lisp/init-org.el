...
(use-package org
  ...
  (custom-set-faces
   ...
   '(org-level-5 ((t (:inherit outline-5 :height 1.0 :family "Maple Mono NF CN"))))
   '(org-level-4 ((t (:inherit outline-4 :height 1.05 :family "Maple Mono NF CN"))))
   '(org-level-3 ((t (:inherit outline-3 :height 1.1 :family "Maple Mono NF CN"))))
   '(org-level-2 ((t (:inherit outline-2 :foreground "#EEC591" :height 1.15 :family "Maple Mono NF CN"))))
   '(org-level-1 ((t (:inherit outline-1 :foreground "#076678" :weight extra-bold
			       :height 1.2 :family "Maple Mono NF CN"))))
